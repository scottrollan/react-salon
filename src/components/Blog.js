...
const Blog = props => {
    ...
    return(
        <Jumbotron id="blog" style={{margin: '0', padding: '5%' }}>
            <p id="fromBarry" style={{ maxWidth: '27%', float: 'left', marginRight: '12px' }}><b>From Barry</b></p>
            <div>
            ...
            { expandState.expanded 
                ...
                <p style={props.textStyle}>To me, that distinction is made when a brand is able to remove every ingredient that is <em>known</em> to be harmful whenever there is a viable, less- or non-toxic substitute. </p>
                ...
                <p style={props.textStyle}>With current technology, the truth is that to <em>reliably and predictably</em> alter the pigmentation of hair, a chemical process must take place. That, of course, doesn't mean that we shouldn't care which chemicals are used, but it does mean chemicals must be present.</p>
