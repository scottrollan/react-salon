    ...
    return(
        ...
        <div>                        
            { expandState.expanded 
                ...
                <p className='lead' style={props.textStyle}>To me, that distinction is made when a brand is able to remove every ingredient that is <em>known</em> to be harmful whenever there is a viable, less- or non-toxic substitute. </p>
                <p className='lead' style={props.textStyle}>Through years of research and hands-on experience, I believe O&amp;M Cor Color to be the best product line available to meet that distinction. </p>
                <p className='lead' style={props.textStyle}>With current technology, the truth is that to <em>reliably and predictably</em> alter the pigmentation of hair, a chemical process must take place. That, of course, doesn't mean that we shouldn't care which chemicals are used, but it does mean chemicals must be present.</p>
                ...
                <p className='lead' style={props.textStyle}>With all that said, my commitment to my clients, and to myself, is that I will attempt to know about, and use, the least-toxic, professional color line available that performs effectively and predictably.  Right now, I believe O&amp;M Cor Color to be that line. </p>
                <p className='lead' style={props.textStyle} id="signature"><em>- Barry</em></p>
                <button 
