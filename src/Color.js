    ...
    return(
        <div className="page">
            ...
            <Carousel style={{marginBottom: '2vh', borderRadius: "0 0 3vw 3vw", zIndex: '999 !important' }}>
                <Carousel.Item>
                    <img src={Myth1} class="d-block w-100" alt="" style={{margin: 0, zIndex: '999', borderRadius: "0 0 3vw 3vw" }}/>
                </Carousel.Item>
                <Carousel.Item>
                <img src={Myth2} class="d-block w-100" alt=""style={{margin: 0, zIndex: '999', borderRadius: "0 0 3vw 3vw" }} />
                </Carousel.Item>
                <Carousel.Item>
                <img src={Myth3} class="d-block w-100" alt="" style={{margin: 0, zIndex: '999', borderRadius: "0 0 3vw 3vw" }}/>
                </Carousel.Item>       
                <Carousel.Item>
                    <img src={Myth4} class="d-block w-100" alt="" style={{margin: 0, zIndex: '999', borderRadius: "0 0 3vw 3vw" }}/>
                </Carousel.Item>
                <Carousel.Item>
                    <img src={Myth5} class="d-block w-100" alt="" style={{margin: 0, zIndex: '999', borderRadius: "0 0 3vw 3vw" }}/>
                </Carousel.Item>
            </Carousel>
